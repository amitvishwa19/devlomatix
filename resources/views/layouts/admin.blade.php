...
<html>
  <head>
    ...
    <link class="main-stylesheet" href="{{asset('public/assets/css/light.css')}}" rel="stylesheet" type="text/css" />
    @yield('style')
  ...
  <body class="fixed-header dashboard menu-pin">
    ...
    <nav class="page-sidebar" data-pages="sidebar">
        <div class="sidebar-header">
            <h4><b>DevloMatix</b></h4>
        </div>

        <div class="sidebar-menu">

            <ul class="menu-items">
                <li class="m-t-30 @yield('dashboard')">
                ...
                <li class="@yield('posts')">
                    <a href="{{route('posts.index')}}" class="detailed">
    ...
    <div class="page-container ">
        ...
        <div class="header ">
            ...
            <div class="d-flex align-items-center">
                                ...
                                <div class="notification-panel">
                                    ...
                                    <div class="notification-item unread clearfix">
                                        ...
                                        <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                                            <img width="30" height="30" data-src-retina="{{asset('public/assets/img/profiles/1x.jpg')}}" data-src="{{asset('public/assets/img/profiles/1x.jpg')}}" alt="" src="{{asset('public/assets/img/profiles/1.jpg')}}">
                                        </div>
                                        <a href="#" class="text-primary pull-left">
                ...
                <div class="pull-left p-r-10 fs-14 font-heading d-lg-inline-block d-none m-l-20">
                    <span class="semi-bold">{{ucfirst(Auth::user()->firstName)}}</span>
                    <span class="text-master">{{ucfirst(Auth::user()->lastName)}}</span>
                </div>
                <div class="dropdown pull-right d-lg-inline-block d-none">
                    <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="thumbnail-wrapper d32 circular inline">
                    <img src="{{asset('public/assets/img/profiles/avatar.jpg')}}" alt="" data-src="{{asset('public/assets/img/profiles/avatar.jpg')}}" data-src-retina="{{asset('public/assets/img/profiles/avatar.jpg')}}" width="32" height="32">
                    </span>
                    </button>
        ...
        <div class="page-content-wrapper ">
            ...
            <div class="content sm-gutter">
                ...
                <div class="container-fluid p-l-25 p-r-25 p-t-0 p-b-25 sm-padding-10">
                    ...
                    {{-- <div id="alert" class="alert alert-success" role="alert">
                        <button class="close" data-dismiss="alert" style="color: #000"></button>
            ...
            <div class="copyright sm-text-center">
                ...
                <span class="font-montserrat">DevloMatix</span>.
