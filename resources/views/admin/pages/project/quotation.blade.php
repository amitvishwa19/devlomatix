                ...
                <div class="page-title-box">
                    <div class="row">
                        ...
                        <div class="col-auto align-self-center">
                            <a href="" data-toggle="modal" class="btn btn-info waves-effect waves-light btn-sm" >Print</a>
                            <a href="{{route('project.quotation.pdf',$project->id)}}" class="btn btn-info waves-effect waves-light btn-sm" >Mail</a>
                            <a href="{{route('project.show',$project->id)}}" class="btn btn-info waves-effect waves-light btn-sm" >Back</a>
                        </div>
                    </div><!--end row-->
