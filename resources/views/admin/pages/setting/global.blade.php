    ...
    <div class="card-body">
        <form action="{{route('setting.store',['type'=>'global'])}}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" value="{{$settings->get('app_name')}}">
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">App Description</label>
                <input type="text" class="form-control" name="description" value="{{$settings->get('app_description')}}">
            </div>
