...
@section('content')
    ...
    <div class="wrapper pb-2">
        ...
        <form role="form" method="post" action="{{route('shoppee.product.update',$product->id)}}" enctype="multipart/form-data">
            @csrf
            {{method_field('PUT')}}    
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="" class="form-control" cols="30" rows="2">{{$product->description}}</textarea>
