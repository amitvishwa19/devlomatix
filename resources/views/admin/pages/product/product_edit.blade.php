    ...
    <div class="wrapper pb-2">
        ...
        <form role="form" method="post" action="{{route('product.update',$product->id)}}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <select name="sku" id="" class="form-control">
                                    ...
                                    <option value="Kg" {{$product->sku == 'Kg' ? "selected" : ""}}>Kg</option>
                                    <option value="Grms" {{$product->sku == 'Grms' ? "selected" : ""}}>Grms</option>
                                    <option value="Peice" {{$product->sku == 'Peice' ? "selected" : ""}}>Peice</option>
                                    <option value="Dozen" {{$product->sku == 'Dozen' ? "selected" : ""}}>Dozen</option>
                                </select>
                                @if ($errors->has('sku'))
                                    <span class="error">
                    ...
                    <div class="form-group">
                        ...
                        <div class="card-img-top img-fluid bg-light-alt avatar-preview" @if($product->feature_image) style="display:block;height:100px;width:100px;background-image:url({{$product->feature_image}});background-size:contain" @endif></div>
                    ...
                    <div class="checkbox check-success  mt-2">
                        <input type="checkbox" name="featured" value="1" id="checkbox1" {{$product->featured == true ? 'checked' : ''}}>
                        <label for="checkbox1"><b>Featured</b></label>
                    </div>

                    <div class="checkbox check-success  mt-2">
                        <input type="checkbox" name="status" value="1" id="checkbox2" {{$product->status == true ? 'checked' : ''}}>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">    
                        ...
                        <select class="select2 select2-multiple select2-hidden-accessible" style="width: 100%" name="related[]" multiple="">
            ...
            <div class="form-group mt-4">
                <button class="btn btn-info waves-effect waves-light btn-sm">Update Product</button>
            ...
            $("#imageUpload").change(function() {
                ...
                if (this.files && this.files[0]) {
                    ...
                    reader.onload = function(e) {
                            ...
                            $('.avatar-preview').css('width', '100px');
