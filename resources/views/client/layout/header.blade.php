...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('public/client/css/icons.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('public/client/css/animate.min.css')}}">
